            ...
            {services.map((service, index) => (
              ...
              >
                <button
                  ...
                  className="group block w-full text-left rounded-2xl border border-border bg-card p-6 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300 h-full cursor-pointer"
                >
